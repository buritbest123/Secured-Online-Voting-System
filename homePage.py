...
def Home(root, frame1, frame2):
    ...
    # Clear existing widgets but keep the logo if already displayed
    ...
    # Load and display the logo only if it hasn't been displayed yet
    if not logo_displayed:
        ...
        image_label = tk.Label(root, image=logo_image, bg=bgColor)
